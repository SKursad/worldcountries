...
})({"9SQZ1":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "2976caad06b755bc";
...
},{}],"8URUr":[function(require,module,exports) {
...
function getLanguages(languages) {
    if (languages.length === 4) return `The spoken languages are ${languages[0].name}, ${languages[1].name}, ${languages[2].name} or ${languages[3].name}`;
    else if (languages.length === 3) return `The spoken languages are ${languages[0].name}, ${languages[1].name} or ${languages[2].name}`;
    else if (languages.length === 2) return `The spoken languages are ${languages[0].name} and ${languages[1].name}`;
    else return `The spoken language is ${languages[0].name}`;
}
...
},{}]},["9SQZ1","8URUr"], "8URUr", "parcelRequirecb08")

//# sourceMappingURL=CountriesPart2.06b755bc.js.map
